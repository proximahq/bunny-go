/*
This package provides a client for the bunny.net HTTP API.
Heavily inspired by the DigitalOcean go client and https://github.com/simplesurance/bunny-go which is no longer maintained.
*/
package bunnynet
...
func NewClient(APIKey string, opts ...Option) *Client {
	...
	// TODO: Partially release the services
